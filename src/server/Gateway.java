...
public class Gateway implements GatewayInterface {
	...
	public static void setPermissions() {
		...
		// ryan client 15/08/2024
				permissions.add(new Permission("10.215.34.249", "127.0.0.1", 5001, "Autenticação", true));
				permissions.add(new Permission("10.215.34.249", "127.0.0.1", 5002, "Loja1", true));
				permissions.add(new Permission("10.215.34.249", "127.0.0.1", 5003, "Loja2", true));
				permissions.add(new Permission("10.215.34.249", "127.0.0.1", 5004, "Loja3", true));
